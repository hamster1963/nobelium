...
const BlogPost = ({ post }) => {
  ...
  return (
    <Link href={`${BLOG.path}/${post.slug}`}>
      <article key={post.id} className="mb-2 md:mb-2 hover:bg-stone-100 dark:hover:bg-white dark:hover:bg-opacity-5  -m-3  p-3 rounded-md cursor-pointer transition-colors duration-200">
